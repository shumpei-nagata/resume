...
10年以上の間保守運用されてきたレガシーなアプリの内製化から、SwiftUI, Kotlin Multiplatformなどの新技術を用いた新規アプリ開発まで幅広く担当してきました。
...
「レコチョク」「プレイパス」をはじめとする4つの音楽サービスをサポートする音楽再生アプリ「PlayPASS Music Player」アプリのリニューアル・エンハンスを担当しました。
...
NFCタグを内蔵した商品をスマホにかざすと、商品に紐づいたコンテンツを再生できるアプリ「P!TNE」の新規開発に携わりました。
...
Eggsアプリ開発チームにアドバイザーとして参加し、Findy Team+を用いて開発生産性を改善する取り組みのサポートしました。
...
ホットペッパービューティーアプリの開発チームに、iOSアプリエンジニアとして参画しました。
...
インディーズアーティストとそのリスナーのためのプラットフォーム「Eggs」のアプリをリニューアルするプロジェクト。
...
- 難しい物事でも粘り強く向き合うことで正しく理解し、チームへ還元します
  ...
  - 自分の理解が完全でないことを前提認識として、ハンズオンやAI活用を通して自身の理解をアップデートしする
...
- 事業ドメイン
  - 特定のドメインへの強いこだわりはありません
  - 会社のビジョンへ共感でき、その課題を技術で解決し、会社としても利益が得られると感じられればモチベーションを持てる
