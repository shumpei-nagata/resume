...
また、単に開発業務を行うだけでなく、定量的なデータをもとにした開発生産性の改善施策の実施、定期的な1on1や勉強会開催によるチーム全体の技術力向上など、開発チーム全体に目を向けた取り組みも行なっています。
...
- 担当業務
  ...
  - 開発環境整備(XcodeGen, asdf, Bundler, CocoaPods, Swift Package Manager)
  - 各種テストの導入(Unit Test, Snapshot Test, MagicPod)
  - リファクタリング
  - ドキュメント整備
  - FairPlay StreamingによるDRM動画再生実装
  - Findy Team+を用いた開発生産性改善
...
#### Eggsアプリ開発チーム 開発生産性向上サポート

Eggsアプリ開発チームにアドバイザーとして参加し、Findy Team+を用いた開発生産性改善の取り組みのサポートを行いました。
...
- 難しい物事でも粘り強く向き合うことで正しく理解し、チームへ還元します
  - アプリの譲渡対応、NFCタグやFairPlay Streamingの技術仕様など、複雑な物事も一次ソースを参照し、正しく理解することを重視します
  - 自分の理解が完全でないことを前提認識として、ハンズオンやAI活用を通して自身の理解をアップデートします
  - 参照した知識を資料やドキュメントとしてまとめ、自身の理解を深めつつチームへ知見を共有することを重視します
- 手段に固執せず、目的に応じて適切な手段をとる柔軟性があります
  - 手段先行ではなく、目的やゴールを明確化しその時々に適切な技術・ツールの選定を行います
  - 過去に経験のある技術だけでなく、必要に応じて新しい技術も学んで活用します
- コミュニケーションを重視しています
  - テキスト・口頭問わず、相手の前提知識や何を知りたいのかを常に意識し、使用する語彙や情報量をその場に応じて調整します
  - チームとして協働するために、目的や前提知識に対する認識齟齬を減らす働きを積極的に行います
...
- 事業ドメイン
  ...
  - 会社のビジョンへ共感でき、その課題を技術で解決し、会社としても利益が得られると感じられればモチベーションを持って仕事ができると考えています
